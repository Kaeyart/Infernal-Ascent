...
static func build_last_run_panel_text() -> String:
	...
	lines.append("")
	lines.append("Reward Gained:")
	lines.append(str(summary.get("reward_text", "No reward recorded.")))
	lines.append("")
	lines.append("Currency:")
	lines.append("Ash Sigils gained this run: %s" % str(summary.get("ash_sigils_gained", "0")))
	lines.append("Current Ash Sigils: %d" % RunEconomyData.get_ash_sigils())
	lines.append("Lifetime Ash Sigils earned this session: %d" % RunEconomyData.get_lifetime_ash_sigils_earned())
	lines.append("")
	lines.append("Notes:")
	lines.append(str(summary.get("note", "No notes.")))
	lines.append("")
	lines.append("Future Run Results features:")
	lines.append("- currency spending")
	...
	lines.append("Ash Sigils are now real session currency, but they cannot be spent yet.")
...
static func _build_no_run_text() -> String:
	...
	lines.append("- view Ash Sigils earned")
	lines.append("")
